...
btn_clear = tk.Button(root, text="C", command = clear_field, width=15, font=("Arial",14))
btn_clear.grid(row =6, column=3, columnspan=2)
btn_equals = tk.Button(root, text="=", command = evalutate_calculation, width=15, font=("Arial",14))
